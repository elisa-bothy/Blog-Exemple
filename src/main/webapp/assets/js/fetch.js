...
let heure; const saintsAvecSexe=[];
    ...
    if (prenomsMajeurs) {
        ...
        if (!nomsPrenomsMajeurs[1]){
            ...
            if (saintsAvecSexe[0].sexe === "féminin"){
                saint1.src = `<c:url value="/assets/photos/icons8-angel-100.png" />`;
                saint1.alt = "Un ange pour représenter le saint féminin du jour";
            }
            else{
                saint1.src = `<c:url value="/assets/photos/icons8-halo-100.png" />`;
        ...
        if (nomsPrenomsMajeurs[1]){
            ...
            if (saintsAvecSexe[1].sexe === "féminin"){
                saint2.src = `<c:url value="/assets/photos/icons8-angel-100.png" />`;
                saint2.alt = "Un ange pour représenter le saint féminin du jour";
            }
            else{
                saint2.src = `<c:url value="/assets/photos/icons8-halo-100.png" />`;
